...
private:
	...
	void PopulateSpecialModifierSets();
...
public:
	...
	UFUNCTION(BlueprintPure)
	float GetAveragePerkModifierValue(FGameplayTag type) const;
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly)
	void Authority_RemoveStatusEffectByClass(const UClass* effectClass, bool bRemoveAllOfSameClass);
